...
export function MatterAuditClient({ initialData }: { initialData: PaginatedAuditResult }) {
  ...
  function handleExportCsv() {
    ...
    anchor.href = url;
    anchor.download = "matter-audit.csv";
    anchor.click();
  ...
  return (
    <section className="matter-tab-panel audit-workspace">
      <div className="surface-card audit-hero">
        <div>
          <p className="eyebrow-label">Matter Audit</p>
          <h2 className="section-title">Immutable operational history for the matter</h2>
        ...
        <div className="audit-hero-actions">
          <span className="matter-inline-note">Append-only history</span>
        ...
        <div className="surface-card audit-feed-panel">
          {initialData.items.length === 0 ? (
            <div className="empty-state">
              Audit history will populate automatically as work happens on this matter.
            </div>
